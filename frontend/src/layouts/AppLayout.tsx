  ...
  return (
    <div>
      ...
      >
        ...
        {!controller.officeReady ? (
          <PaneSkeleton kind="boot" label={t("app.bootSkeletonAria")} />
        ) : (
          <>
            ...
            {activeModule === "workpapers" &&
            isVisibleAppModule("workpapers") ? (
              <Workpapers
                ...
                {!inspectionFocused && activeStep === "step-import" ? (
                  <DocumentLibraryPanel
                    ...
                    onRename={(documentId, fileName) =>
                      void controller.actions.renameDocument(
                        documentId,
                        fileName,
                      )
                    }
                    ...
                    <details>
                      ...
                      <div className="mt-2">
                        <TemplateLibraryPanel
                          ...
                          onSave={(name) =>
                            controller.actions.saveTemplate(name)
                          }
