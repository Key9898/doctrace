    ...
    build: {
      ...
      rollupOptions: {
        input: {
          ...
          signin: path.resolve(__dirname, "frontend/sign-in.html"),
          signup: path.resolve(__dirname, "frontend/sign-up.html"),
          authCode: path.resolve(__dirname, "frontend/auth-code.html"),
