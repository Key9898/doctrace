...
Committed source of truth for architecture, conventions, and Impl history.

| Page                                                              | Purpose                            |
| ----------------------------------------------------------------- | ---------------------------------- |
| [Folder map](03-folder-map.md)                                    | Current `frontend/src/` layout     |
| [Code conventions](conventions/code.md)                           | Styling and collaboration rules    |
| [Handoff](conventions/handoff.md)                                 | Wiki + session + Lark Task         |
